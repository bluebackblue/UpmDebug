...
/** BlueBack.Debug.Editor
*/
#if(UNITY_EDITOR)
namespace BlueBack.Debug.Editor
{
	/** UpdatePackage
	*/
	public static class UpdatePackage
	{
		...
		*/
		...
		[UnityEditor.MenuItem("BlueBack/Debug/UpdatePackage/Develop")]
		#endif
		...
		*/
		#if(!USERDEF_BLUEBACK_DEBUG)
		[UnityEditor.MenuItem("BlueBack/Debug/UpdatePackage/Last " + Version.packageversion)]
		#endif
		public static void MenuItem_UpdatePackage_Last()
		{
			string t_version = Inner_GetLastReleaseNameFromGitHub();
			if(t_version != null){
				string t_name = "https://github.com/bluebackblue/UpmDebug.git?path=BlueBackDebug/Assets/UPM#" + t_version;
				UnityEditor.PackageManager.Requests.AddRequest t_request = UnityEditor.PackageManager.Client.Add(t_name);
				while(t_request.Status == UnityEditor.PackageManager.StatusCode.InProgress){
					if(UnityEditor.EditorUtility.DisplayCancelableProgressBar(t_name,t_name,1.0f) == true){
						break;
		...
		*/
		...
		{
			string t_url = "https://api.github.com/repos/bluebackblue/UpmDebug/releases/latest";
